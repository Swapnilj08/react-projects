...
//		user.setEmail("swapnilj07");
//		user.setAge(26);
//		
//		
//		Contact contact = new Contact();
//		contact.setAddress("Pune");
//		contact.setMobileno("554546546");
//		contact.setNickname("shep");
//		List<Contact> con = List.of(contact);
//		user.setContacts(con);
//		userRepository.save(user);
	...
	public String register(@Valid @ModelAttribute("user") User user,BindingResult bindresult,
		...
		try {
			...
			//Role always Should be "ROLE_USER/ADMIN" otherwise security will throw forbidden access error
			user.setRole("User");
